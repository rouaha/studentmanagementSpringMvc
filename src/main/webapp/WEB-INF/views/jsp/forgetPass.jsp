...
<head>
    ...
    <script src="${contextPath}/resources/core/js/forgetPass.js" type="text/javascript"></script>
...
<div class="container" ng-app="Myapp" ng-controller="ForgetPassContrl">
    ...
    <form class="well form-horizontal" id="contact_form">
        <fieldset>
            ...
            <!-- Form Name -->
            <legend>
                <center><h2><b>Forget password?</b></h2></center>
            </legend>
            <br>
            ...
            <div class="alert alert-success" role="alert" id="success_message" ng-show="successDialog">Success <i
                    class="glyphicon glyphicon-thumbs-up"></i> Success!.{{TempPass}}<a href="/resetPassword">Reset
                Password</a></div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4"><br>
                    ...
                    <button type="submit" class="btn btn-warning" ng-click="forgetPass(user)">
